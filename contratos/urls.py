...
urlpatterns = [
    ...
    path('processo/<int:processo_id>/peticao-dados/', views.update_peticao_dados, name='update_peticao_dados'),
    path('processo/<int:processo_id>/peticao-custas-preview/', views.preview_peticao_custas, name='preview_peticao_custas'),
    ...
    path('arquivo/<int:arquivo_id>/zip-contents/', views.arquivo_zip_contents_view, name='arquivo_zip_contents'),
