...
urlpatterns = [
    ...
    path('tarefas/notificacoes/', views.TarefaNotificacaoListAPIView.as_view(), name='tarefa_notificacoes_list'),
    path('tarefas/notificacoes/<int:notificacao_id>/marcar-lida/', views.TarefaNotificacaoMarcarLidaAPIView.as_view(), name='tarefa_notificacao_marcar_lida'),
    path('tarefas/bulk/', views.TarefaBulkCreateAPIView.as_view(), name='tarefa_bulk_create'),
    path('tarefas/bulk/history/', views.TarefaBulkHistoryAPIView.as_view(), name='tarefa_bulk_history'),
    path('tarefas/bulk/history/action/', views.TarefaBulkHistoryActionAPIView.as_view(), name='tarefa_bulk_history_action'),
    path('prazos/bulk/', views.PrazoBulkCreateAPIView.as_view(), name='prazo_bulk_create'),
