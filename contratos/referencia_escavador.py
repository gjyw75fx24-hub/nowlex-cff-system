...
# Escavador API - Token via variável de ambiente
ESCAVADOR_AUTH_TOKEN = os.getenv('ESCAVADOR_API_TOKEN', '')
ESCAVADOR_HEADERS = {
    'Authorization': f'Bearer {ESCAVADOR_AUTH_TOKEN}',
    'X-Requested-With': 'XMLHttpRequest',
}

# JusBrasil API - Token via variável de ambiente
JUSBRASIL_API_BASE_URL = "https://op.digesto.com.br/api/base-judicial/tribproc/"
JUSBRASIL_BEARER_TOKEN = os.getenv('JUSBRASIL_BEARER_TOKEN', '')
JUSBRASIL_HEADERS = {
